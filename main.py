...
# Durum 1: Oksijen Kritik
if spo2 < 94:
    st.sidebar.error(f"🚨 **KRİTİK UYARI:** Oksijen %{spo2}!")
    
# Durum 2: Bütünleşik Risk Yüksek
elif risk_skoru > 60:
    st.sidebar.warning(f"⚠️ **YÜKSEK RİSK:** Skor %{risk_skoru}!")
    
# Durum 3: HRV Düşük
elif hrv < 45:
    st.sidebar.info("ℹ️ **BİLGİ:** HRV düşük.")
